const CACHE_NAME = 'rox-calc-v1.2.4.188';
const urlsToCache = [
  '/sim/',
  '/sim/index.html',
  ...
  '/sim/scripts/roxtimizer/hows.js',
  '/sim/scripts/roxtimizer/main.js',
  '/sim/scripts/roxtimizer/utilities.js',
  '/sim/manifest.json',
  '/sim/changelog.json',
  '/sim/img/optimized.gif',
  '/sim/img/hai.png',
  '/sim/img/dogekek.png',
  '/sim/img/pepekekcry.png',
  '/sim/img/pepelaugh.png',
  ...
  '/sim/img/01_RoXtimizer.jpg',
  '/sim/img/02_RoXtimizer.jpg',
  '/sim/img/03_RoXtimizer.jpg',
  '/sim/img/04_RoXtimizer.jpg',
  '/sim/img/05_RoXtimizer.jpg',
  '/sim/img/06_RoXtimizer.jpg',
  '/sim/img/07_RoXtimizer.jpg',
  '/sim/img/Roxtimizer_STR_Multiplier.jpg',
