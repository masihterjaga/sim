...
function renderMultiplierBreakdown(calculationState) {
  ...
  resultContainer.innerHTML = `
    <div class="multiplier-breakdown" id="multiplier-breakdown">
      ...
      <p>or if you're ignoring value of attack, your base multiplier is consistently around ×${wrapCode(fmt.finalMult(multWithoutAttack, showFullPrecision))}</p>
